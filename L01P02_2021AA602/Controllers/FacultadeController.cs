...
using L01P02_2021AA602.Models;

namespace L01P02_2021AA602.Controllers
{
    public class FacultadeController : Controller
    {
        private readonly DbNotasContext _context;

        public FacultadeController(DbNotasContext context)
        {
            _context = context;
        }
        ...
        // GET: Facultade/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Facultade/Create
